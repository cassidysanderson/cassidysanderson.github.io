...
function init (){
     pipes = [ [250, 200, 50, 150],[350, 150, 50, 100],[480, 100, 50, 50] ]; // [x, y, w, h] of the passage
    birdY = 100;
...
function isOver () {
    ...
    for (var i = 0; i < pipes.length; ++i) {
        ...
        if (isXyInRect(birdX, birdY+birdSize, pipe[0], pipe[1]+pipe[3], pipe[2], pipe[4]) ||
...
function drawBackground () {
    ...
    painter. fillRect (30, 40, 100, 40)

    painter.fillStyle = '#FFFFFF';
    painter. fillRect (20, 60, 100, 40)

    painter.fillStyle = '#FFFFFF';
    painter. fillRect (150, 20, 80, 30)

    painter.fillStyle = '#FFFFFF';
    painter. fillRect (140, 30, 100, 30)

    painter.fillStyle = '#FFFFFF';
    painter. fillRect (300, 20, 90, 30)

    painter.fillStyle = '#FFFFFF';
    painter. fillRect (300, 40, 120, 30)

    painter.fillStyle = '#FFFFFF';
    painter. fillRect (230, 170, 90, 35)

    painter.fillStyle = '#FFFFFF';
    painter. fillRect (200, 150, 150, 30)
